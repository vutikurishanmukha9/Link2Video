...
def test_rejects_unsupported_domains():
    with pytest.raises(UnsupportedPlatformException):
        validate_and_guard_url("https://www.tiktok.com/@user/video/1234567")

    with pytest.raises(UnsupportedPlatformException):
        validate_and_guard_url("https://www.pinterest.com/pin/123456789/")


def test_allows_valid_platform_domains():
    valid_urls = [
